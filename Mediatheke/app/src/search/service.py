  ...
  def media_items_to_jsonl(self, media_items: List[MediaItem]) -> str:
    ...
    for media_item in media_items:
        json_obj = json.dumps({
            ...
            'url_video_ut': media_item.url_video_ut or "",
            'url_video_low_ut': media_item.url_video_low_ut or "",
            'url_video_hd_ut': media_item.url_video_hd_ut or "",
            'url_video_ov': media_item.url_video_ov or "",
            'url_video_low_ov': media_item.url_video_low_ov or "",
            'url_video_hd_ov': media_item.url_video_hd_ov or "",
            'url_video_ov_ut': media_item.url_video_ov_ut or "",
            'url_video_low_ov_ut': media_item.url_video_low_ov_ut or "",
            'url_video_hd_ov_ut': media_item.url_video_hd_ov_ut or "",
