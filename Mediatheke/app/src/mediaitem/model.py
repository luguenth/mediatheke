...
class MediaItem(Base):
    ...
    url_video_ut = Column(String, nullable=True)
    url_video_low_ut = Column(String, nullable=True)
    url_video_hd_ut = Column(String, nullable=True)
    url_video_ov = Column(String, nullable=True)
    url_video_low_ov = Column(String, nullable=True)
    url_video_hd_ov = Column(String, nullable=True)
    url_video_ov_ut = Column(String, nullable=True)
    url_video_low_ov_ut = Column(String, nullable=True)
    url_video_hd_ov_ut = Column(String, nullable=True)
